...
3. Only if you believe the visualization is misleading, specify which visualization rhetoric techniques may have contributed to making this visualization misleading.
